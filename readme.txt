...
Tags: Accordion,tabs,simple accordion,wordpress plugin
...
Accordions Plugin is pure HTML & CSS3 responsive accordion grid for WordPress  
...
add shortcode in your page [accordion]
